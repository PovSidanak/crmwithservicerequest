                      ...
                      <h6 class="card-title" style="color: black;">Call Detail</h6>
                          ...
                          <form id="myForm" method="POST" action="" class="forms-sample" >
                            ...
                            <div  class="row" >
                                ...
                                <div class="col-sm-3">
                                    <div class="mb-4" >
                                        <label  class="form-label" style="color: gray;">ATM ID <span>:</span></label>
                            ...
                            <div  class="row" >
                                ...
                                <div class="col-sm-3">
                                    <div class="mb-4" >
                                        <label for="exampleInputEmail1" class="form-label" style="color: gray;">Service Code<span>:</span></label>
                            ...
                            <div  class="row" >
                                ...
                                <div class="col-sm-3">
                                    <div class="mb-4" >
                                        <label for="exampleInputEmail1" class="form-label" style="color: gray;">Ticket Ownership<span>:</span></label>
                                        <input type="number" name="phone" class="form-control" style="color: black;background-color:aliceblue" required>
                                    </div>
                                    </div>
                                <div class="col-sm-3">
                                  <div class="mb-4" >
                                      <label  class="form-label" style="color: gray;">Model<span>:</span></label>
                                      <select style="color: black;background-color:aliceblue"  class="js-example-basic-single form-select select2-hidden-accessible" name="call_type" data-width="100%" data-select2-id="1" tabindex="-1" aria-hidden="true" required>
                                        <option value="Under Processing" data-select2-id="3">Under Processing</option>
                                        <option value="Finished" data-select2-id="13">Finished</option>
                                    </select>
                            ...
                            <div  class="row" >
                                ...
                                <div class="col-sm-3">
                                    <div class="mb-4" >
                                        <label for="exampleInputEmail1" class="form-label" style="color: gray;">Status<span>:</span></label>
                                        <input type="number" name="phone" class="form-control" style="color: black;background-color:aliceblue" required>
                                    </div>
                                    </div>
                                <div class="col-sm-3">
